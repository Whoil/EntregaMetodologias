...
/**
 *  A Test Driver for the es.uah.matcomp.mp.e1.ejerciciosclases.Circle class
 */
public class TestCircle {  // Save as "es.uah.matcomp.mp.e1.ejerciciosclases.TestCircle.java"
    public static void main(String[] args) {
        // Declare an instance of es.uah.matcomp.mp.e1.ejerciciosclases.Circle class called c1.
        ...
        System.out.println("The circle radius of " + c3.getRadius()+ " and area of " + c3.getArea() + " and color is " + c3.getColor() );
        Circle c4 = new Circle();   // construct an instance of es.uah.matcomp.mp.e1.ejerciciosclases.Circle
